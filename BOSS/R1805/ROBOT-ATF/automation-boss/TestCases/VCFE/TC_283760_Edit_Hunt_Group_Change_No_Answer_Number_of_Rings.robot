*** Settings ***
Documentation     Login to BOSS portal and Edit Hunt Group - Change No Answer Number of Rings
#...               dev-Vasuja
#...               Comments:
...
1 Login as Staff user and Edit Hunt Group - Change No Answer Number of Rings
    [Tags]    Regression    HG
    ...
    Set to Dictionary    ${HuntgroupEdit}    No_answer_number_of_rings    5
...
2 Login as DM and Edit Hunt Group - Change No Answer Number of Rings
    [Tags]    Regression    HG
...
3 Login as PM and Edit Hunt Group - Change No Answer Number of Rings
    [Tags]    Regression    HG
