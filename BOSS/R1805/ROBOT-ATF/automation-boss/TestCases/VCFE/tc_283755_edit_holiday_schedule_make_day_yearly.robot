*** Settings ***
Documentation     Login to BOSS portal and Edit Holiday Schedule - Make Day Yearly
#...               dev-Vasuja
#...               Comments:
...
*** Test Cases ***
1 Login as staff user and Edit Holiday Schedule - Make Day Yearly
    [Tags]    Regression    HS
    ...
    Set to Dictionary    ${HolidayScheduleEdit}    Holidays    Yearly
...
2 Login as DM user and Edit Holiday Schedule - Make Day Yearly
    [Tags]    Regression    HS
...
3 Login as PM user and Edit Holiday Schedule - Make Day Yearly
    [Tags]    Regression    HS
