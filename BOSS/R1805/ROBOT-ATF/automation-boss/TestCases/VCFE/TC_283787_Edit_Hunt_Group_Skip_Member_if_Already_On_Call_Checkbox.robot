...
1 Login as Staff user and Edit_Hunt_Group_Skip_Member_if_Already_On_Call_Checkbox
    [Tags]    Regression    HG
    ...
    Set to Dictionary    ${HuntgroupEdit}    Skip_member_if_already_on_a_call    True
...
2 Login as DM and Edit_Hunt_Group_Skip_Member_if_Already_On_Call_Checkbox
    [Tags]    Regression    HG
...
3 Login as PM and Edit_Hunt_Group_Skip_Member_if_Already_On_Call_Checkbox
    [Tags]    Regression    HG
