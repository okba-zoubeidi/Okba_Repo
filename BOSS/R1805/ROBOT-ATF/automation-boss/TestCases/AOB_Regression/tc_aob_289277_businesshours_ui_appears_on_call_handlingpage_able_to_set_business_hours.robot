...
*** Test Cases ***
Business Hours UI appears on Call Handling Page. Able to set Business Hours.
    [Tags]  Regression
    ...
    And I click "Save" button
    When I select "Business Hours" option on call handling summary page
    Then I check "Reset" is present
