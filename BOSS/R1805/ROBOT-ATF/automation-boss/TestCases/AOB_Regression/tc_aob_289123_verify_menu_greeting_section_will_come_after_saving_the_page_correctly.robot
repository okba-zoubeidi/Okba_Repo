...
*** Test Cases ***
Verify Menu greeting section will come after saving the page correctly
    [Tags]  Regression
...
#    And I click "Save" button
    ...
    And I select "Menu Greeting" option on call handling summary page
    Then I check text "Menu Greeting" is present
