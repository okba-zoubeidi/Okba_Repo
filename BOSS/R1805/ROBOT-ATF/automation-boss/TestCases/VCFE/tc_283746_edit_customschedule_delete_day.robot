*** Settings ***
Documentation    To edit custom schedule delete day
...                 Palla Surya Kumar
...
*** Test Cases ***
Edit Custom Schedule delete day as DM:
    [Tags]    Regression    CS
    ...
    Set to Dictionary    ${EditCustomSchedule01}    deletevcfeday   True
    #and I edit custom schedule    &{EditCustomSchedule01}   deletevcfeday   ${True}
    ...
    ...                      I log off
    ...                      I check for alert
Edit Custom Schedule delete day as PM:
    [Tags]    Regression    CS
    ...
    Set to Dictionary    ${EditCustomSchedule02}    deletevcfeday   True
    #and I edit custom schedule    &{EditCustomSchedule02}   deletevcfeday   ${True}
