...
verify calendar sector
    ...
    ${num}=   Run Keyword If   '${ch_status}' == 'False'   run keyword   I fetch selected number from call handling page
    Run Keyword If   '${ch_status}' == 'False'   run keyword   I select "Save" button on call handling page
    Run Keyword If   '${ch_status}' == 'False'   run keyword   I check text "${num}" is present

    Run Keyword If   '${ch_status}' == 'True'   run keyword    I check "Continue" is present
    ...
    Run Keyword If   '${ch_status}' == 'True'   run keyword   I select "Set Up" button on call handling page
    Run Keyword If   '${ch_status}' == 'True'   run keyword   I verify the page "Main Number"
    Run Keyword If   '${ch_status}' == 'True'   run keyword   I select "Existing" option to setup call handling with phone number
    ${num}=   Run Keyword If   '${ch_status}' == 'True'   run keyword   I fetch selected number from call handling page
    Run Keyword If   '${ch_status}' == 'True'   run keyword   I select "Save" button on call handling page
    Run Keyword If   '${ch_status}' == 'True'   run keyword   I check text "${num}" is present
