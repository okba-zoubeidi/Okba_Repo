...
class AutomationConfig(object):
    ...
    def load_testbed_config(self):
        ...
        for i in range(0, int(numTestbeds)):
            tbNum = i
            #TEMPLATE_START
            ROBOT_MODULE_CONFIG_DIR = 'ROBOT_MODULE_CONFIG_DIR=%s' % testbedDict["ROBOT_MODULE_CONFIG_DIR"]
            testbed_name = 'testbed_name=%s' % testbedDict["testbed_name"]
            HQ1_PASSWORD = 'HQ1_PASSWORD=%s' % testbedDict["HQ1_PASSWORD"]
            HQ1_UNAME = 'HQ1_UNAME=%s' % testbedDict["HQ1_UNAME"]
            login_password = 'login_password=%s' % testbedDict["login_password"]
            login_uname = 'login_uname=%s' % testbedDict["login_uname"]
            NEW_HI = 'NEW_HI=%s' % testbedDict["NEW_HI"]
            hq1_kWorkgroup_Extension = 'hq1_kWorkgroup_Extension=%s' % testbedDict["hq1_kWorkgroup_Extension"]
            hq1_kWorkgroup_Name = 'hq1_kWorkgroup_Name=%s' % testbedDict["hq1_kWorkgroup_Name"]
            hq1_kWorkgroup_Member = 'hq1_kWorkgroup_Member=%s' % testbedDict["hq1_kWorkgroup_Member"]
            hq1_kHuntgroup_Extension = 'hq1_kHuntgroup_Extension=%s' % testbedDict["hq1_kHuntgroup_Extension"]
            hq1_kHuntgroup_Name = 'hq1_kHuntgroup_Name=%s' % testbedDict["hq1_kHuntgroup_Name"]
            MODULE_LDVS = 'MODULE_LDVS=%s' % testbedDict["MODULE_LDVS"]
            MODULE_VSWITCH = 'MODULE_VSWITCH=%s' % testbedDict["MODULE_VSWITCH"]
            MODULE_ALLVIRTUAL = 'MODULE_ALLVIRTUAL=%s' % testbedDict["MODULE_ALLVIRTUAL"]
            MODULE_SQUISH = 'MODULE_SQUISH=%s' % testbedDict["MODULE_SQUISH"]
            MODULE_NONSQUISH = 'MODULE_NONSQUISH=%s' % testbedDict["MODULE_NONSQUISH"]
            MODULE_MANHATTAN = 'MODULE_MANHATTAN=%s' % testbedDict["MODULE_MANHATTAN"]
            GERMANY_SITE = 'GERMANY_SITE=%s' % testbedDict["GERMANY_SITE"]
            SWEDEN_SITE = 'SWEDEN_SITE=%s' % testbedDict["SWEDEN_SITE"]
            AUSTRALIA_SITE = 'AUSTRALIA_SITE=%s' % testbedDict["AUSTRALIA_SITE"]
            NEW_ZEALAND_SITE = 'NEW_ZEALAND_SITE=%s' % testbedDict["NEW_ZEALAND_SITE"]
            FRANCE_SITE = 'FRANCE_SITE=%s' % testbedDict["FRANCE_SITE"]
            UK_SITE = 'UK_SITE=%s' % testbedDict["UK_SITE"]
            USA_SITE = 'USA_SITE=%s' % testbedDict["USA_SITE"]
            SPAIN_SITE = 'SPAIN_SITE=%s' % testbedDict["SPAIN_SITE"]
            CHINA_SITE = 'CHINA_SITE=%s' % testbedDict["CHINA_SITE"]
            SEND_EMAILS = 'SEND_EMAILS=%s' % testbedDict["SEND_EMAILS"]
            USE_LOCK_FILE = 'USE_LOCK_FILE=%s' % testbedDict["USE_LOCK_FILE"]
            IMAGE_PREFIX = 'IMAGE_PREFIX=%s' % testbedDict["IMAGE_PREFIX"]
            NETWORK_LOGIN_PASSWORD = 'NETWORK_LOGIN_PASSWORD=%s' % testbedDict["NETWORK_LOGIN_PASSWORD"]
            NETWORK_LOGIN_USERNAME = 'NETWORK_LOGIN_USERNAME=%s' % testbedDict["NETWORK_LOGIN_USERNAME"]
            ESXI_SERVER = 'ESXI_SERVER=%s' % testbedDict["ESXI_SERVER"]
            ESXI_LOGIN = 'ESXI_LOGIN=%s' % testbedDict["ESXI_LOGIN"]
            ESXI_PASSWORD = 'ESXI_PASSWORD=%s' % testbedDict["ESXI_PASSWORD"]
            ARC_SERVER_IP = 'ARC_SERVER_IP=%s' % testbedDict["ARC_SERVER_IP"]
            ARC_SERVER_LOCAL_DRIVE_SHARE_NAME = 'ARC_SERVER_LOCAL_DRIVE_SHARE_NAME=%s' % testbedDict["ARC_SERVER_LOCAL_DRIVE_SHARE_NAME"]
            ARC_CLIENT_NETWORK_FOLDER = 'ARC_CLIENT_NETWORK_FOLDER=%s' % testbedDict["ARC_CLIENT_NETWORK_FOLDER"]
            ARC_LOG_FOLDER = 'ARC_LOG_FOLDER=%s' % testbedDict["ARC_LOG_FOLDER"]
            ARC_SCRIPT_FOLDER = 'ARC_SCRIPT_FOLDER=%s' % testbedDict["ARC_SCRIPT_FOLDER"]
            ARC_HOST_OS = 'ARC_HOST_OS=%s' % testbedDict["ARC_HOST_OS"]
            PERL_LIBRARY_FOLDER = 'PERL_LIBRARY_FOLDER=%s' % testbedDict["PERL_LIBRARY_FOLDER"]
            BUILD_DRIVE_LETTER = 'BUILD_DRIVE_LETTER=%s' % testbedDict["BUILD_DRIVE_LETTER"]
            ARC_COPYCLIENTFILE_MAXWAITTIME = 'ARC_COPYCLIENTFILE_MAXWAITTIME=%s' % testbedDict["ARC_COPYCLIENTFILE_MAXWAITTIME"]
            USE_STAGING_AREA = 'USE_STAGING_AREA=%s' % testbedDict["USE_STAGING_AREA"]
            STAGING_AREA_LOCATION = 'STAGING_AREA_LOCATION=%s' % testbedDict["STAGING_AREA_LOCATION"]
            STAGING_AREA_USERNAME = 'STAGING_AREA_USERNAME=%s' % testbedDict["STAGING_AREA_USERNAME"]
            STAGING_AREA_PASSWORD = 'STAGING_AREA_PASSWORD=%s' % testbedDict["STAGING_AREA_PASSWORD"]
            STAGING_AREA_DRIVE_LETTER = 'STAGING_AREA_DRIVE_LETTER=%s' % testbedDict["STAGING_AREA_DRIVE_LETTER"]
            STAGING_AREA_COPYFROM_DRIVE_LETTER = 'STAGING_AREA_COPYFROM_DRIVE_LETTER=%s' % testbedDict["STAGING_AREA_COPYFROM_DRIVE_LETTER"]
            VTF_NUM_TGL_ATTEMPTS = 'VTF_NUM_TGL_ATTEMPTS=%s' % testbedDict["VTF_NUM_TGL_ATTEMPTS"]
            VTF_TGL_FOLDER_PATH = 'VTF_TGL_FOLDER_PATH=%s' % testbedDict["VTF_TGL_FOLDER_PATH"]
            VTF_SUMMARY_PATH = 'VTF_SUMMARY_PATH=%s' % testbedDict["VTF_SUMMARY_PATH"]
            VTF_TESTSUITE_PATH = 'VTF_TESTSUITE_PATH=%s' % testbedDict["VTF_TESTSUITE_PATH"]
            VTF_SHORETELCRON_PATH = 'VTF_SHORETELCRON_PATH=%s' % testbedDict["VTF_SHORETELCRON_PATH"]
            PSERIES_BUILD_SERVER_IPADDRESS = 'PSERIES_BUILD_SERVER_IPADDRESS=%s' % testbedDict["PSERIES_BUILD_SERVER_IPADDRESS"]
            PSERIES_PHONE1_IPADDRESS = 'PSERIES_PHONE1_IPADDRESS=%s' % testbedDict["PSERIES_PHONE1_IPADDRESS"]
            PSERIES_PHONE2_IPADDRESS = 'PSERIES_PHONE2_IPADDRESS=%s' % testbedDict["PSERIES_PHONE2_IPADDRESS"]
            CAS_REVERSE_PROXY = 'CAS_REVERSE_PROXY=%s' % testbedDict["CAS_REVERSE_PROXY"]
            CAS_REVERSE_PROXY_IP_ADDRESS = 'CAS_REVERSE_PROXY_IP_ADDRESS=%s' % testbedDict["CAS_REVERSE_PROXY_IP_ADDRESS"]
            HQ1_IMAGENAME = 'HQ1_IMAGENAME=%s' % testbedDict["HQ1_IMAGENAME"]
            HQ1_IPADDRESS = 'HQ1_IPADDRESS=%s' % testbedDict["HQ1_IPADDRESS"]
            HQ1_ISIMAGESELECTABLE = 'HQ1_ISIMAGESELECTABLE=%s' % testbedDict["HQ1_ISIMAGESELECTABLE"]
            HQ1_SELECTIONVARIANTS = 'HQ1_SELECTIONVARIANTS=%s' % testbedDict["HQ1_SELECTIONVARIANTS"]
            HQ1_MAINSWITCH_IPADDRESS = 'HQ1_MAINSWITCH_IPADDRESS=%s' % testbedDict["HQ1_MAINSWITCH_IPADDRESS"]
            HQ1_MAINSWITCH_LINUXTYPE = 'HQ1_MAINSWITCH_LINUXTYPE=%s' % testbedDict["HQ1_MAINSWITCH_LINUXTYPE"]
            HQ2_IMAGENAME = 'HQ2_IMAGENAME=%s' % testbedDict["HQ2_IMAGENAME"]
            HQ2_IPADDRESS = 'HQ2_IPADDRESS=%s' % testbedDict["HQ2_IPADDRESS"]
            HQ2_ISIMAGESELECTABLE = 'HQ2_ISIMAGESELECTABLE=%s' % testbedDict["HQ2_ISIMAGESELECTABLE"]
            HQ2_SELECTIONVARIANTS = 'HQ2_SELECTIONVARIANTS=%s' % testbedDict["HQ2_SELECTIONVARIANTS"]
            HQ2_MAINSWITCH_IPADDRESS = 'HQ2_MAINSWITCH_IPADDRESS=%s' % testbedDict["HQ2_MAINSWITCH_IPADDRESS"]
            HQ2_MAINSWITCH_LINUXTYPE = 'HQ2_MAINSWITCH_LINUXTYPE=%s' % testbedDict["HQ2_MAINSWITCH_LINUXTYPE"]
            RM1_IMAGENAME = 'RM1_IMAGENAME=%s' % testbedDict["RM1_IMAGENAME"]
            RM1_IPADDRESS = 'RM1_IPADDRESS=%s' % testbedDict["RM1_IPADDRESS"]
            RM1_ISIMAGESELECTABLE = 'RM1_ISIMAGESELECTABLE=%s' % testbedDict["RM1_ISIMAGESELECTABLE"]
            RM1_SELECTIONVARIANTS = 'RM1_SELECTIONVARIANTS=%s' % testbedDict["RM1_SELECTIONVARIANTS"]
            VSWITCH_PHONE_IMAGENAME = 'VSWITCH_PHONE_IMAGENAME=%s' % testbedDict["VSWITCH_PHONE_IMAGENAME"]
            VSWITCH_PHONE_IPADDRESS = 'VSWITCH_PHONE_IPADDRESS=%s' % testbedDict["VSWITCH_PHONE_IPADDRESS"]
            VSWITCH_PHONE_ISIMAGESELECTABLE = 'VSWITCH_PHONE_ISIMAGESELECTABLE=%s' % testbedDict["VSWITCH_PHONE_ISIMAGESELECTABLE"]
            VSWITCH_PHONE_LINUXTYPE = 'VSWITCH_PHONE_LINUXTYPE=%s' % testbedDict["VSWITCH_PHONE_LINUXTYPE"]
            VSWITCH_TRUNK_IMAGENAME = 'VSWITCH_TRUNK_IMAGENAME=%s' % testbedDict["VSWITCH_TRUNK_IMAGENAME"]
            VSWITCH_TRUNK_IPADDRESS = 'VSWITCH_TRUNK_IPADDRESS=%s' % testbedDict["VSWITCH_TRUNK_IPADDRESS"]
            VSWITCH_TRUNK_ISIMAGESELECTABLE = 'VSWITCH_TRUNK_ISIMAGESELECTABLE=%s' % testbedDict["VSWITCH_TRUNK_ISIMAGESELECTABLE"]
            VSWITCH_TRUNK_LINUXTYPE = 'VSWITCH_TRUNK_LINUXTYPE=%s' % testbedDict["VSWITCH_TRUNK_LINUXTYPE"]
            VSWITCH2_PHONE_IMAGENAME = 'VSWITCH2_PHONE_IMAGENAME=%s' % testbedDict["VSWITCH2_PHONE_IMAGENAME"]
            VSWITCH2_PHONE_IPADDRESS = 'VSWITCH2_PHONE_IPADDRESS=%s' % testbedDict["VSWITCH2_PHONE_IPADDRESS"]
            VSWITCH2_PHONE_ISIMAGESELECTABLE = 'VSWITCH2_PHONE_ISIMAGESELECTABLE=%s' % testbedDict["VSWITCH2_PHONE_ISIMAGESELECTABLE"]
            VSWITCH2_PHONE_LINUXTYPE = 'VSWITCH2_PHONE_LINUXTYPE=%s' % testbedDict["VSWITCH2_PHONE_LINUXTYPE"]
            VSWITCH2_TRUNK_IMAGENAME = 'VSWITCH2_TRUNK_IMAGENAME=%s' % testbedDict["VSWITCH2_TRUNK_IMAGENAME"]
            VSWITCH2_TRUNK_IPADDRESS = 'VSWITCH2_TRUNK_IPADDRESS=%s' % testbedDict["VSWITCH2_TRUNK_IPADDRESS"]
            VSWITCH2_TRUNK_ISIMAGESELECTABLE = 'VSWITCH2_TRUNK_ISIMAGESELECTABLE=%s' % testbedDict["VSWITCH2_TRUNK_ISIMAGESELECTABLE"]
            VSWITCH2_TRUNK_LINUXTYPE = 'VSWITCH2_TRUNK_LINUXTYPE=%s' % testbedDict["VSWITCH2_TRUNK_LINUXTYPE"]
            COMPLETE_IMAGE_LIST = 'COMPLETE_IMAGE_LIST=%s' % testbedDict["COMPLETE_IMAGE_LIST"]
            
            testbed_factory = BuiltIn().create_dictionary(ROBOT_MODULE_CONFIG_DIR,testbed_name,HQ1_PASSWORD,HQ1_UNAME,login_password,login_uname,NEW_HI,hq1_kWorkgroup_Extension,hq1_kWorkgroup_Name,hq1_kWorkgroup_Member,hq1_kHuntgroup_Extension,hq1_kHuntgroup_Name,MODULE_LDVS,MODULE_VSWITCH,MODULE_ALLVIRTUAL,MODULE_SQUISH,MODULE_NONSQUISH,MODULE_MANHATTAN,GERMANY_SITE,SWEDEN_SITE,AUSTRALIA_SITE,NEW_ZEALAND_SITE,FRANCE_SITE,UK_SITE,USA_SITE,SPAIN_SITE,CHINA_SITE,SEND_EMAILS,USE_LOCK_FILE,IMAGE_PREFIX,NETWORK_LOGIN_PASSWORD,NETWORK_LOGIN_USERNAME,ESXI_SERVER,ESXI_LOGIN,ESXI_PASSWORD,ARC_SERVER_IP,ARC_SERVER_LOCAL_DRIVE_SHARE_NAME,ARC_CLIENT_NETWORK_FOLDER,ARC_LOG_FOLDER,ARC_SCRIPT_FOLDER,ARC_HOST_OS,PERL_LIBRARY_FOLDER,BUILD_DRIVE_LETTER,ARC_COPYCLIENTFILE_MAXWAITTIME,USE_STAGING_AREA,STAGING_AREA_LOCATION,STAGING_AREA_USERNAME,STAGING_AREA_PASSWORD,STAGING_AREA_DRIVE_LETTER,STAGING_AREA_COPYFROM_DRIVE_LETTER,VTF_NUM_TGL_ATTEMPTS,VTF_TGL_FOLDER_PATH,VTF_SUMMARY_PATH,VTF_TESTSUITE_PATH,VTF_SHORETELCRON_PATH,PSERIES_BUILD_SERVER_IPADDRESS,PSERIES_PHONE1_IPADDRESS,PSERIES_PHONE2_IPADDRESS,CAS_REVERSE_PROXY,CAS_REVERSE_PROXY_IP_ADDRESS,HQ1_IMAGENAME,HQ1_IPADDRESS,HQ1_ISIMAGESELECTABLE,HQ1_SELECTIONVARIANTS,HQ1_MAINSWITCH_IPADDRESS,HQ1_MAINSWITCH_LINUXTYPE,HQ2_IMAGENAME,HQ2_IPADDRESS,HQ2_ISIMAGESELECTABLE,HQ2_SELECTIONVARIANTS,HQ2_MAINSWITCH_IPADDRESS,HQ2_MAINSWITCH_LINUXTYPE,RM1_IMAGENAME,RM1_IPADDRESS,RM1_ISIMAGESELECTABLE,RM1_SELECTIONVARIANTS,VSWITCH_PHONE_IMAGENAME,VSWITCH_PHONE_IPADDRESS,VSWITCH_PHONE_ISIMAGESELECTABLE,VSWITCH_PHONE_LINUXTYPE,VSWITCH_TRUNK_IMAGENAME,VSWITCH_TRUNK_IPADDRESS,VSWITCH_TRUNK_ISIMAGESELECTABLE,VSWITCH_TRUNK_LINUXTYPE,VSWITCH2_PHONE_IMAGENAME,VSWITCH2_PHONE_IPADDRESS,VSWITCH2_PHONE_ISIMAGESELECTABLE,VSWITCH2_PHONE_LINUXTYPE,VSWITCH2_TRUNK_IMAGENAME,VSWITCH2_TRUNK_IPADDRESS,VSWITCH2_TRUNK_ISIMAGESELECTABLE,VSWITCH2_TRUNK_LINUXTYPE,COMPLETE_IMAGE_LIST)
            #TEMPLATE_END
