*** Settings ***
Documentation     Login to BOSS portal and Edit Hunt Group - Change Rings per Member
#...               dev-Vasuja
#...               Comments:
...
1 Login as Staff user and Edit Hunt Group - Change Rings per Member
    [Tags]    Regression    HG
    ...
    Set to Dictionary    ${HuntgroupEdit}    Rings_per_Member    4
...
2 Login as DM and Edit Hunt Group - Change Rings per Member
   [Tags]    Regression    HG
...
3 Login as PM and Edit Hunt Group - Change Rings per Member
    [Tags]    Regression    HG
