...
class LocalBrowser(Browser):
    _DEFAULT_TIMEOUT = 15
    _BROWSER_INFO_WIN = {'firefox'       : {'webdriver_path': '..\\ext_web_driver\\windows\\geckodriver.exe'},
    ...
    _BROWSER_INFO_MAC = {'firefox': {'webdriver_path': '..\\ext_web_driver\\mac\\geckodriver'},
