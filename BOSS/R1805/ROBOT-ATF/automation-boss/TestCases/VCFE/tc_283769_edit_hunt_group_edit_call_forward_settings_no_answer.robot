...
1 Login as Staff user and Edit Hunt Group - Edit Call Forward Settings - No answer
    [Tags]    Regression    HG
    Given I login to ${URL} with ${bossUsername} and ${bossPassword}
    When I switch to "switch_account" page
    And I switch to account ${SCOCosmoAccount} with ${AccWithoutLogin} option
    Set to Dictionary    ${HuntgroupEdit}    no_answer    ${user_extn}
...
2 Login as DM and Edit Hunt Group - Edit Call Forward Settings - No answer
    [Tags]    Regression    HG
...
3 Login as PM and Edit Hunt Group - Edit Call Forward Settings - No answer
    [Tags]    Regression    HG
