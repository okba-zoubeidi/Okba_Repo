*** Settings ***
Documentation     Login to BOSS portal and Edit Hunt Group - Edit Group Members - Remove Member
#...               dev-Vasuja
#...               Comments:
...
*** Test Cases ***
1 Login as staff user and Edit Hunt Group - Edit Group Members - Remove Member
    [Tags]    Regression   HG
    ...
    Set to Dictionary    ${HuntgroupEdit}    grp_member    Delete
...
2 Login as staff user and Edit Hunt Group - Edit Group Members - Remove Member
    [Tags]    Regression   HG
    Given I login to ${URL} with ${phoneDMUser01["user_email"]} and ${phoneDMUser01["password"]}
    And I switch to "Visual_Call_Flow_Editor" page
    Set to Dictionary    ${HuntgroupDM}    grp_member    ${user_extn}
...
3 Login as staff user and Edit Hunt Group - Edit Group Members - Remove Member
    [Tags]    Regression   HG
    Given I login to ${URL} with ${phonePMUser01["user_email"]} and ${phonePMUser01["password"]}
    And I switch to "Visual_Call_Flow_Editor" page
    Set to Dictionary    ${HuntgroupPM}    grp_member    ${user_extn}
