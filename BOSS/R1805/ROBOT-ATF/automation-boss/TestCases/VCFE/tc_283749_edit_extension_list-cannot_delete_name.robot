*** Settings ***
Documentation    To Edit VCFE Extension List and to validate error message Name cannot be blank
...              Immani Mahesh Kumar
...
Vcfe Create Extension list with DM user
    ...
    and Set to Dictionary    ${EditExtensionlist01}    extnlistname    blank
