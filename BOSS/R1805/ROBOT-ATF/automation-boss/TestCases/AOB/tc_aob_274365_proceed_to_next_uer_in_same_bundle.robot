...
*** Test Cases ***
Proceed to next user in same bundle
    [Tags]  Sanity
    ...
    Set to Dictionary    ${AobUserDetail}    bundle    ${bundle_name}     #add bundle name in dictionary
    then I create User  &{AobUserDetail}
    and I click "Save" button         #Cancel or Save
    I check if user switched  &{AobUserDetail}
