*** Settings ***
Documentation     Login to BOSS portal and Edit Hunt group with blank location
#...               dev-Vasuja
#...               Comments:
...
*** Test Cases ***
1 Login as staff user and Edit Hunt Group - Cannot Remove Location
    [Tags]    Regression    HG
    ...
    Set to Dictionary    ${HuntgroupEdit}  hglocation  Delete
...
2 Login as DM user and Edit Hunt Group - Cannot Remove Location
    [Tags]    Regression    HG
...
3 Login as PM user and Edit Hunt Group - Cannot Remove Location
    [Tags]    Regression    HG
