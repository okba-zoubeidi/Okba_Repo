*** Settings ***
Documentation    Verify the Enable Tone check box on Add BCA page with different conferencing options
...
*** Test Cases ***
Validate Enable Tone Check Box on Add BCA Page
    [Tags]    Regression
    ...
    ### Verification
    Then I varify enable tone checkbox on add bca page

    [Teardown]
    Run Keywords  I log off
    ...           I check for alert

Verify Enable Tone with Conferencing Option Disable Conferencing
    [Tags]    Regression
...
Verify Enable Tone with Conferencing Option Enable Others May Not Join
    [Tags]    Regression
...
Verify Enable Tone with Conferencing Option Enable Others May Join
    [Tags]    Regression
