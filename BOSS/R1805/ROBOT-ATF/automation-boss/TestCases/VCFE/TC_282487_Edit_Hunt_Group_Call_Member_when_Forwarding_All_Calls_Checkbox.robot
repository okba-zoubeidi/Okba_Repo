...
1 Login as Staff user and Edit Hunt Group - Call Member when Forwarding All Calls Checkbox
    ...
    Set to Dictionary    ${HuntgroupEdit}    Call_member_when_forwarding_all_calls    True
...
2 Login as DM and Edit Hunt Group - Call Member when Forwarding All Calls Checkbox
    [Tags]    Regression    HG    AUS    UK
...
3 Login as PM and Edit Hunt Group - Call Member when Forwarding All Calls Checkbox
    [Tags]    Regression    HG    AUS    UK
