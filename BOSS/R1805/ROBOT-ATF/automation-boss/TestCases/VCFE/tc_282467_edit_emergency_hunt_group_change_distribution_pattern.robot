*** Settings ***
Documentation     Login to BOSS portal and Edit Emergency Hunt Group - Change Distribution Pattern
#...               dev-Vasuja
#...               Comments:
...
1 Login as DM and Edit Emergency Hunt Group - Change Distribution Pattern
    [Tags]    Regression    EHG
...
2 Login as PM and Edit Emergency Hunt Group - Change Distribution Pattern
    [Tags]    Regression    EHG
...
3 Login as Staff user and Edit Emergency Hunt Group - Change Distribution Pattern
    [Tags]    Regression    EHG
