...
Library  String
*** Test Cases ***
Press cancel button after enterting user detail
    [Tags]  Sanity
    ...
    Set to Dictionary    ${AobUserDetail}    phone    None     #other option: "Existing"- To select phone number or "None"- Not to select any ohone number
    ...
    and I click "Cancel" button         #Cancel or Save
    and I check user field values
