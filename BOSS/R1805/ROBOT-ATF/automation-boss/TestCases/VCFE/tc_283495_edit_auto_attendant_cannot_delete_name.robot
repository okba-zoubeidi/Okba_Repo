*** Settings ***
Documentation  Login To Boss Portal And Edit An Auto Attendant And Removing the Name
...            Mahesh
...
*** Test Cases ***
01 Removing The Name for AA as a DM user
    [Tags]    AA    Regression
