*** Settings ***
Documentation    To Edit Paging group and chage the name to one which is already in use
...              Immani Mahesh Kumar
...
Vcfe edit Paging group with DM user
    ...
    Then I switch to "Visual_Call_Flow_Editor" page
    ${extn_num2}=   I add Paging Group    &{Paginggroupedit_PM}
    Set to Dictionary    ${Paginggroupedit}    Pg_Extension    ${extn_num}
    Set to Dictionary    ${Paginggroupedit}    Pg_Name  ${Paginggroupedit_PM['Pg_Name']}
