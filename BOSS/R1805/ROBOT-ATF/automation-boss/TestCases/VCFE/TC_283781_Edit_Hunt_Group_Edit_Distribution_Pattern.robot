*** Settings ***
Documentation     Login to BOSS portal and Edit Hunt Group - Distribution Pattern
#...               dev-Vasuja
#...               Comments:
...
1 Login as Staff user and Edit Hunt Group - Edit Distribution Pattern
    [Tags]    Regression    HG
    ...
    Set to Dictionary    ${HuntgroupEdit}    Distribution_pattern    Simultaneous
...
2 Login as DM and Edit Hunt Group - Edit Distribution Pattern
    [Tags]    Regression    HG
...
3 Login as PM and Edit Hunt Group - Edit Distribution Pattern
    [Tags]    Regression    HG
