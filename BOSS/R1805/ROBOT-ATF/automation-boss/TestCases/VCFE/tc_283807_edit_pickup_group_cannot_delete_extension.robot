*** Settings ***
Documentation     Login to BOSS portal and Edit Pickup Group - Cannot Delete Extension
#...               dev-Vasuja
#...               Comments:
...
*** Test Cases ***
1 Login as staff user and Edit Pickup Group - Cannot Delete Extension
    [Tags]    Regression    PK
    ...
    Set to Dictionary    ${Pickupgroup_edit}  PGExtn  Delete
...
2 Login as DM user and Edit Pickup Group - Cannot Delete Extension
    [Tags]    Regression    PK
...
3 Login as PM user and Edit Pickup Group - Cannot Delete Extension
    [Tags]    Regression    PK
