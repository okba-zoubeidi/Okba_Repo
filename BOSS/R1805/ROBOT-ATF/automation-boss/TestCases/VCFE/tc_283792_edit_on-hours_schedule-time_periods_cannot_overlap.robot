*** Settings ***
Documentation    To edit On-Hours Schedule And Verify
...              Immani Mahesh Kumar
...
01 Edit On Hours schedule and change settings with DM User
    ...
    Then I edit on-hours schedule   &{EditOnHoursSchedule05}
...
Set Init Env
    ...
    \    Set To Dictionary    ${OnHoursSchedule01}    ${key}    ${updated_val}
     ...
     : FOR    ${key}    IN    @{EditOnHoursSchedule05.keys()}
    \    ${updated_val}=    Replace String    ${EditOnHoursSchedule05["${key}"]}    {rand_str}    ${uni_str}
    \    Set To Dictionary    ${EditOnHoursSchedule05}    ${key}    ${updated_val}