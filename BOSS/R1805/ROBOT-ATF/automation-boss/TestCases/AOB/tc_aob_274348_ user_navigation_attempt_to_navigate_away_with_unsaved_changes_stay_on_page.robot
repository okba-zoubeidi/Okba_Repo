...
Library  String
*** Test Cases ***
Press Stay on page button on Add user page without saving
    [Tags]  Sanity
    ...
    Set to Dictionary   ${AobPopUpOption}   button   Stay on page   #Supported option: "Stay on page" and "Continue"
