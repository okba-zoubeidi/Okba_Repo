...
*** Test Cases ***
Verify Enable operator during off-hours is enabled while click on save button
    [Tags]  Regression
    ...
    And I select "Business Hours" option on call handling summary page
    When I configure business hour in call handling page   &{businessHour}
    And I click "Save" button
    And I select "Operator" option on call handling summary page
    set to dictionary  ${operatorRings}  clear   Yes
    When I configure rings in operator sections   &{operatorRings}
    Then I check text "Required" is present
*** Keywords ***
Set Init Env
