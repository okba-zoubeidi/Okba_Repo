...
*** Test Cases ***
01 Edit Auto Attendant and assign multiple digit operation like go to menu for On Hours Schedule as DM user
    [Tags]    Regression        AA
    ...
    set to dictionary    ${EditAA04}    Multiple_Digit_Operation    GoToMenu
...
02 Edit Auto Attendant and assign multiple digit operation like go to menu for On Hours Schedule as PM user
    [Tags]    Regression        AA
...
03 Edit Auto Attendant and assign multiple digit operation like go to menu for On Hours Schedule as Staff user
    [Tags]    Regression
