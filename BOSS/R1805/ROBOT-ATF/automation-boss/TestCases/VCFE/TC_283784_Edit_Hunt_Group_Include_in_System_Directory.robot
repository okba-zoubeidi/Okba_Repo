...
1 Login as Staff user and Edit Hunt Group - Include in System Directory
    [Tags]    Regression    HG
    ...
    Set to Dictionary    ${HuntgroupEdit}    Include_in_System_Dial_by_Name_directory    False
...
2 Login as DM and Edit Hunt Group - Include in System Directory
    [Tags]    Regression    HG
...
3 Login as PM and Edit Hunt Group - Include in System Directory
    [Tags]    Regression    HG
