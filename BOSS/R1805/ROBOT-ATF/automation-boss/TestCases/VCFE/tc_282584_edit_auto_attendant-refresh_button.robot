...
...             Press Refresh button to verify vcfe component in interactive diagram
...            Mahesh
...
*** Test Cases ***
01 Verify in interactive diagram as DM user
    [Tags]    Regression        AA
    ...
    Set to Dictionary    ${EditAA04}    verify_interactive_diagram    True
...
02 Verify in interactive diagram as PM user
    [Tags]    Regression        AA
...
03 Verify in interactive diagram as Staff user
    [Tags]    Regression        AA
