...
1. Login to Portal as DM and Copy Recurring ECC Report
    ...
    And I select recurring report to copy   &{ReportValues}
    And I click on recurring copy button
    And I click on recurring copy button by giving report name   &{ReportValues}
    And I switch to "eccreports" page
    And I select recurring report to edit after copy   &{ReportValues}
