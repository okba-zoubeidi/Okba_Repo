...
*** Test Cases ***
Verify Update Continue and Reset Button is present or not
    [Tags]  Regression
    ...
    Run Keyword If   '${ch_status}' == 'False'   run keyword   I refesh browser page
    Then I check "Reset" is present
    Then I check "Continue" is present
    Then I check "Update" is present
