*** Settings ***
Documentation  Login To Boss Portal And Edit An Auto Attendant With On Hours Schedule and check whether the On
...            Hours Schedule is Displayed properly for an Auto Attendant
...            Mahesh
...
*** Test Cases ***
01 Edit Auto Attendant and Validate On Hours Schedule name is Displayed Properly as DM user
    [Tags]    Regression
    ...
    Then I select vcfe component by searching extension "${extn_num}"
    Set to Dictionary    ${EditAA05}    Validate_vcfe_name   OnHoursSchedule
    Set to Dictionary    ${EditAA05}    vcfe_name    ${OHS_name}
...
02 Edit Auto Attendant and Validate On Hours Schedule name is Displayed Properly as PM user
    [Tags]    Regression
...
03 Edit Auto Attendant and Validate On Hours Schedule name is Displayed Properly as Staff user
    [Tags]    Regression
