*** Settings ***
Documentation  Login To Boss Portal And Edit An Auto Attendant And Remove Location
...            Mahesh
...
*** Test Cases ***
01 Removing location for AA as a DM user
    [Tags]    AA    Regression
