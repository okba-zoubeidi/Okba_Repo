Testcase:  TC_289996_Verify that location dropdown is disabled .robot

*** Settings ***
Documentation   Verify that location dropdown is disabled for global user in update TN Wizard.
