*** Settings ***
Documentation     Login to BOSS portal and Edit Emergency Hunt Group - Show More Operations
#...               dev-Vasuja
#...               Comments:
...
1 Login as DM and Edit Emergency Hunt Group - Show More Operations
    [Tags]    Regression    EHG    AUS    UK
    ...
    Set to Dictionary    ${EmergencyHG_Edit}    show_more_operations    True
    And I verify emergency hunt group  &{EmergencyHG_Edit}
    [Teardown]  run keywords   I delete vcfe entry for ${EmergencyHG['EHGExtn']}
    ...                        I log off
    ...                       I check for alert

2 Login as PM and Edit Emergency Hunt Group - Show More Operations
    [Tags]    Regression    EHG    AUS    UK
...
3 Login as Staff user and Edit Emergency Hunt Group - Show More Operations
    [Tags]    Regression    EHG    AUS    UK
