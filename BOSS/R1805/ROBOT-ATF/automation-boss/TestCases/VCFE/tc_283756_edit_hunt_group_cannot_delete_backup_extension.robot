*** Settings ***
Documentation     Login to BOSS portal and Edit Hunt Group - Cannot Delete Backup Extension
#...               dev-Vasuja
#...               Comments:
...
*** Test Cases ***
1 Login as staff user and Edit Hunt Group - Cannot Delete Backup Extension
    [Tags]    Regression    HG
    ...
    Set to Dictionary    ${HuntgroupEdit}    HGBckupExtn    Delete
...
2 Login as DM user and Edit Hunt Group - Cannot Delete Backup Extension
    [Tags]    Regression    HG
...
3 Login as PM user and Edit Hunt Group - Cannot Delete Backup Extension
    [Tags]    Regression    HG
