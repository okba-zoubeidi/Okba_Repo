...
Edit custom schedule with DM account
    ...
    Set to Dictionary  ${EditCustomSchedule01}  startTime  10:00 AM
    Set to Dictionary  ${EditCustomSchedule01}  stopTime   11:00 PM
...
Edit custom schedule with PM account
    ...
    Set to Dictionary  ${EditCustomSchedule02}  startTime  10:00 AM
    Set to Dictionary  ${EditCustomSchedule02}  stopTime   11:00 PM
    And I edit custom schedule  &{EditCustomSchedule02}
    Then In D2 ${D2IP} I login with ${D2User} and ${D2Password}
    Then In D2 I verify custom schedule "${EditCustomSchedule02["customScheduleName"]}" is set for ${accountName1}
    [Teardown]  run keywords  I log off
    ...                      I check for alert
